...
import com.example.demo.utils.cert.CertificateVerificationException;
import com.example.demo.utils.cert.CertificateVerifier;
...
public final class ShowSignature
{
    ...
    public void showSignaturePDF(String filePath, String inputPassword) throws IOException,
            GeneralSecurityException,
            TSPException,
            CertificateVerificationException
    {
        ...
        else
        {
            ...
            try (PDDocument document = parser.parse(false))
            {
                ...
                for (PDSignature sig : document.getSignatureDictionaries())
                {
                    ...
                    {
                        i++;
                        System.out.println("Signature found:"+i);
                        ...
                        String filterSign = sig.getFilter();

                        String subFilter = sig.getSubFilter();
                        System.out.println("filterSign: "+filterSign);
            ...
            System.out.println("Analyzed: " + filePath);
        }
    }
}
