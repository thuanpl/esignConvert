...
public class TSAClient
{
    ...
    public byte[] getTimeStampToken(byte[] messageImprint) throws IOException, TSPException {
        this.digest.reset();
        ...
        ASN1ObjectIdentifier oid = new ASN1ObjectIdentifier(NISTObjectIdentifiers.id_rsassa_pkcs1_v1_5_with_sha3_256.getId());
    ...
    public TimeStampToken getTimeStampToken(InputStream content) throws IOException
    {
        ...
        TimeStampRequestGenerator tsaGenerator = new TimeStampRequestGenerator();
        tsaGenerator.setCertReq(true);
        String test = digest.getAlgorithm();
